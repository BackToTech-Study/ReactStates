      ...
      <div className="content">
        <div className="inner">
          <dl>
            ...
            <dd>
              <p>
                A state variable is a variable that holds that state of a
                component.
              </p>
              <p>
                Is declared by calling the hook{' '}
                <span className="code-line">useState</span>
              </p>
            ...
            <dd>
              <p>
                A state update function is a function that can be used to update
                the sate variable.
              </p>
              <p>
                Is declared by calling the hook{' '}
              ...
              <p>
                When you want to change the state of the component use the state
                update function.
              </p>
            ...
            <dd>
              ...
              <p>
                <span className="highlighted">Apply context sparingly</span>{' '}
              ...
              <div>
                <p>
                  ...
                  <span className="highlighted">
                    component composition is often a simpler solution than
                    context.
                  </span>
                </p>
                <div className="code-section">
              ...
              <p>
                You can think of React context as the equivalent of global
                variables for our React components.
              </p>
              <p>
                A context is created with{' '}
                <span className="code-line">createContext</span>
              </p>
              <div className="code-section">
            ...
            <dd>
              ...
              <p>
                The provider passes the context value to the consuming
                components that are descendants of the provider.
              </p>
              <div className="code-section">
            ...
            <dd>
              <p>
                ...
                <span className="code-line">useContext</span> hook.
              </p>
              <div className="code-section">
            ...
            <dd>
              <p>
                To change a context you can set the context value as an object
                with a value field and an update field.
              </p>
              <div className="code-section">
              ...
              <p>
                Where "user" is the value field and "setUser" is the update
                function.
              </p>
              ...
              <p>
                Then the update function "setUser" would call the state update
                function.
              </p>
              <div className="code-section">
              ...
              <p className="highlighted">
                Routing or page refresh will reinitalze the context.
              </p>
              <p>
                If you want context persitance you can setup context to be saved
                and loaded from local storage.
              </p>
              <div className="code-section">
                <p>
